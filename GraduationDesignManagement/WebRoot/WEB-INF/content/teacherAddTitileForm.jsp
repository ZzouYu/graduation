...
<div id="index">
	...
	<s:form action="addTitile" method="get">
			<s:textfield name="title1.title" label="题目标题"></s:textfield>
			<s:textfield name="title1.property" label="题目性质"></s:textfield>
			<s:textfield name="title1.type" label="题目类型"></s:textfield>
			<s:textfield name="title1.term" label="开始学期"></s:textfield>
