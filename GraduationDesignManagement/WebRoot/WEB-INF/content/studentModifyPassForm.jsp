...
<p>
	...
	<s:form action="modifystudentPass" method="get">
	<s:password label="新密码" name="student.password" placeholder="请输入新密码" ></s:password>
	<s:password label="确认密码" name="student.modifyPass" placeholder="请确认新密码"></s:password>
