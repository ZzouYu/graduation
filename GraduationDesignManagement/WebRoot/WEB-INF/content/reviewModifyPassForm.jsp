...
<div id="index">
	<div class="right" id="right">
	  <div class="kcjj">
	    ...
	    <div class="kcjj_wz">
   <p>请修改密码：</p>
	<s:form action="modifyPass" method="get">
	<s:password label="新密码" name="reviewer.password" placeholder="请输入新密码"></s:password>
	<s:password label="确认密码" name="reviewer.modifyPass" placeholder="请确认新密码"></s:password>
